# Architecture — POS Ingestion & Adapter Layer

**Note:** This document describes the **POS data ingestion adapter architecture** — the anti-corruption layer for external POS systems (FoodNotify, HOTAPI, etc.). For the broader **Bevero system architecture**, see [`IDENTITY.md`](../IDENTITY.md), [`OS.md`](../OS.md), and [`apps/api/README.md`](../apps/api/README.md).
